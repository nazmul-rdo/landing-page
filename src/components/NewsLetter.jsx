...
export const NewsLetter = () => {
  return (
    ...
    <div className="flex items-start gap-2 p-4 bg-white flex-col md:flex-row">
      <div className="hidden md:block p-4 w-full animate-bounce animate-infinite animate-duration-[2000ms]  ">
        <img
      ...
      <div className="flex flex-col gap-3 w-full">
        <div className="w-full md:w-[80%]">
          ...
          />
          <button className="bg-orange text-white p-3 rounded-xl px-4 uppercase w-full mt-4 hover:animate-pulse hover:animate-infinite">
            Subscribe
          </button>
        </div>
      </div>
